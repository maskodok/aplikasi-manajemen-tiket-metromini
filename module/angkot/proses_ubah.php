...
<div class="theme-content-area">
	<?php
		...
		if(empty($_POST['kode_angkot'])){
			echo 'Kode Angkot Tidak Boleh Kosong. Isi Lagi 
			<a href="admin.php?page=angkot&action=ubah&id='.$id_angkot.'">Di Sini</a>';
		}
		else if(empty($_POST['tujuan'])){
			echo 'Tujuan Tidak Boleh Kosong. Isi Lagi 
			<a href="admin.php?page=angkot&action=ubah&id='.$id_angkot.'">Di Sini</a>';
		}
		else{
			mysql_query("update tiket_angkot set kode_angkot='$kode_angkot', 
							     tujuan='$tujuan' WHERE id_angkot='$id_angkot'");
